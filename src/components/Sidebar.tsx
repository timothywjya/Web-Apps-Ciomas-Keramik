...
const navGroups = [
  ...
  {
    section: 'Gudang & Operasional', defaultOpen: true,
    items: [
      {
        href: '/goods-receipt',
        label: 'Penerimaan Barang',
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12H19M12 5l7 7-7 7"/><rect x="2" y="7" width="6" height="10" rx="1"/></svg>,
      },
      {
